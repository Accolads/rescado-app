...
class ApiClient extends BaseClient {
  ...
  Future<dynamic> postJson(Uri url, {Map<String, String>? headers, Object? body, Encoding? encoding}) async {
  ...
  Future<dynamic> putJson(Uri url, {Map<String, String>? headers, Object? body, Encoding? encoding}) async {
  ...
  Future<dynamic> patchJson(Uri url, {Map<String, String>? headers, Object? body, Encoding? encoding}) async {
  ...
  Future<dynamic> deleteJson(Uri url, {Map<String, String>? headers, Object? body, Encoding? encoding}) async {
